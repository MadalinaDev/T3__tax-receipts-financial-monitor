...
export const categorizeProductsWithOpenAI = async (receipts: ReceiptWithProducts[]) => {
  try {
    ...
    const response = await openai.chat.completions.create({
      ...
      messages: [
        {
          role: "user",
          content: `DO NOT use markdown code blocks,backticks, or any text before or after JSON.
